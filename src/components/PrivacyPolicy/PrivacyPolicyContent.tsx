    ...
    <>
      <div className="py-[50px] md:py-[60px] lg:py-[80px] xl:py-[100px]">
        <div className="container mx-auto px-[15px]">
          ...
          <p className="text-[14px] md:text-[15px] text-[#4c4c4c] leading-[1.7] mb-[15px] last:mb-0">
            Hi there, we’re <strong className="text-black">AXIS IT ADVISOR</strong>, and
            ...
            you’re an <strong className="text-black">AXIS IT ADVISOR</strong> user or
            visitor to our site.
          </p>
          <p className="text-[14px] md:text-[15px] text-[#4c4c4c] leading-[1.7] mb-[15px] last:mb-0">
            When we say ‘we’, ‘us’, or ‘
            <strong className="text-black">AXIS IT ADVISOR</strong>’, it’s because that’s
          ...
          <p className="text-[14px] md:text-[15px] text-[#4c4c4c] leading-[1.7] mb-[15px] last:mb-0">
            ...
            <strong className="text-black">AXIS IT ADVISOR</strong> visitors who do not
            wish to have cookies placed on their browsers should set their
            browsers to refuse cookies before using the{" "}
            <strong className="text-black">AXIS IT ADVISOR</strong> site.
          </p>
          ...
          <p className="text-[14px] md:text-[15px] text-[#4c4c4c] leading-[1.7] mb-[15px] last:mb-0">
            ...
            <strong className="text-black">AXIS IT ADVISOR</strong> services, you can
          ...
          <p className="text-[14px] md:text-[15px] text-[#4c4c4c] leading-[1.7] mb-[15px] last:mb-0">
            ...
            our support at{" "}
            <a
              href="mailto:hello@AXIS IT ADVISOR.com"
              className="text-[#0a64bc] transition-all hover:underline"
            >
              hello@AXIS IT ADVISOR.com
            </a>
            .
          </p>
          <p className="text-[14px] md:text-[15px] text-[#4c4c4c] leading-[1.7] mb-[15px] last:mb-0">
