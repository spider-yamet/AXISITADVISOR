...
const Partner = () => {
  return (
    <>
      <div className="relative before:content-[''] before:absolute before:top-0 before:left-0 before:bg-[#EF4335] before:w-full before:h-[50%] before:z-0">
        <div className="container lg:max-w-[1710px] mx-auto relative z-1">
          <div className="bg-[#F2F2F8] rounded-[20px] pt-[50px] md:pt-[80px] lg:pt-[80px] xl:pt-[107px] pb-[50px] md:pb-[50px] lg:pb-[80px] xl:pb-[109px] pl-[20px] md:pl-[58px] lg:pl-[30px] xl:pl-[50px] 2xl:pl-[110px] pr-[20px] md:pr-[58px] lg:pr-[30px] xl:pr-[50px] 2xl:pr-[58px]">
